    ...
    <div className="p-3">
      <form onSubmit={handleSubmit} className="p-3">
        ...
        <div className="flex justify-between">
          ...
          {handleDelete && (
            <button onClick={handleDelete} className="bg-red-500 text-white py-3 px-4 rounded-lg hover:bg-red-600 focus:outline-none  focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 ">Delete</button>
          )}
        </div>
      </form>
    </div>
